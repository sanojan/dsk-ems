  ...
  <!-- messages -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add New Qualification</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
            <li class="breadcrumb-item active">Add New Qualification</li>
            </ol>
        </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">        
            ...
            <div class="card card-warning">
                ...
                <h3 class="card-title">Qualifications of {{$staff->firstname}}</h3>
                  ...
                  <!-- form start -->
                  <div class="container">
                  {!! Form::open(['action' => 'QualificationsController@store', 'method' => 'POST']) !!}
                  <div class="row">
                    <div class="col-sm-4">
